    ...
    return (
        <div>
           ...
           <div className='relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center
            ...
            transition-all duration-200 hover:drop-shadow-none hover:scale-95 w-fit drop-shadow-[0_1.5px_rgba(255,255,255,0.25)] '>
            ...
            {/* Unlock power code CARD SECTION */}
            <ExploreMore/>
           ...
           <div className='bg-pure-greys-5 text-richblack-700'>
                <div className='homepage_bg h-[310px]'>
                    ...
                    <div className='flex h-[150px]'></div>
