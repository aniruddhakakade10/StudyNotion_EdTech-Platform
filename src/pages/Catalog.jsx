...
import Course_Card from "../components/core/Catalog/Course-Card";
        ...
        <>
            <div className=" box-content bg-richblack-800 px-4">
                ...
                <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
                    ...
                    <p className="text-richblack-5 font-semibold mt-3 underline">Top Courses</p>
                    <div className="py-8">
