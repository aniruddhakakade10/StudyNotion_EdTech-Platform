    ...
    const isFormUpdated = () =>{
      ...
      const handleEditSubSection = async () => {
       ...
       const onSubmit = async (data) => {
            ...
            // API Call to create a new lecture
            ...
            >
                ...
                <div className="flex flex-col space-y-2">
                    ...
                    <div className="flex flex-col space-y-2">
                        ...
                        {
                            errors.lectureDesc && (
                                <span className="ml-2 text-xs tracking-wide text-pink-200">Lecture Description is required <sup className="text-pink-200">*</sup></span>
                            )
                        }
                    </div>
                    {
