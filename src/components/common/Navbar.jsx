                           ...
                           return  <li key={index}>
                                {
                                    ...
                                    <>
                                        ...
                                        left-[50%] top-[50%] flex w-[210px] flex-col rounded-md bg-richblack-5 p-4 
                                        text-richblack-900 opacity-0 transition-all duration-150 group-hover:visible group-hover:translate-y-[1.65em] group-hover:opacity-100 lg:w-[300px] z-10">

                                            <div className="absolute left-[50%] top-0 -z-10  translate-x-[80%]
                                             translate-y-[-45%] h-6 w-6 rotate-45 select-none rounded bg-richblack-5">
                                            </div>
